...
var require = {
	app: {
		analytics: true,
		copyright: "2013 by julioahuactzin",
		deployType: "development",
		description: "not specified",
		guid: "33c05304-7dad-4d72-9367-8bf1d98c016d",
		id: "com.monkeymachin",
		name: "EventsAndProperties",
		names: {},
		publisher: "julioahuactzin",
		url: "http://monkeymachin.com",
		version: "1.0"
	},
	has: {
...
p.setString("acs-api-key-production","RNtYTHO4bf7b4GC8lzEovXr1s43fPweU");
p.setString("acs-api-key-development","KhYPGpISvdWirl3LjzWj1i4HP8nTelQ1");
p.setString("acs-oauth-secret-development","t7e7ZzcdAHTCb43pq7xpQLQgpUKtgp2P");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","19aHAYxpcc27D9ZyuwUxXTbqthoJuTyK");
p.setString("acs-oauth-key-development","s0My1xUvu2QUWxtU5eX4WNsZYwPg1Qzf");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","9ElE0cIjwG2RBur85n3QwNbplZuYQPsP");
});
