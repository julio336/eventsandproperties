...
@interface EventsAndPropertiesObject : KrollCoverageObject {
#else
@interface EventsAndPropertiesObject : KrollObject {
#endif
@private
...
extern NSString * EventsAndProperties$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	EventsAndPropertiesObject *_eventsandproperties;
    KrollObject* console;
	BOOL shutdown;
