...
//Rare exceptions to indicate a bug in the _eventsandproperties code (Eg, function that a subclass should have implemented)
...
/**
 The base class for EventsAndProperties proxies.
 */
