...
/**
 Base class for all EventsAndProperties views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the EventsAndProperties view hierarchy (such as wrapped iOS UIViews) was touched.
