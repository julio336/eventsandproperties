...
static NSString * const kEventsAndPropertiesJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_eventsandpropertiesInjection
{
	...
	[html appendString:kEventsAndPropertiesJavascript];
...
{
	// attempt to make well-formed HTML and inject in our EventsAndProperties bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _eventsandpropertiesInjection]];
