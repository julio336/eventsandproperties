...
// in simulator we redefine to format for EventsAndProperties Developer console
...
{\
	NSString * exceptionName = [@"org.eventsandproperties." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.eventsandproperties";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIEventsAndPropertiesNativeItemNone = -1, 
	UIEventsAndPropertiesNativeItemSpinner = -2,
	UIEventsAndPropertiesNativeItemProgressBar = -3,
	
	UIEventsAndPropertiesNativeItemSlider = -4,
	UIEventsAndPropertiesNativeItemSwitch = -5,
	UIEventsAndPropertiesNativeItemMultiButton = -6,
	UIEventsAndPropertiesNativeItemSegmented = -7,
	
	UIEventsAndPropertiesNativeItemTextView = -8,
	UIEventsAndPropertiesNativeItemTextField = -9,
	UIEventsAndPropertiesNativeItemSearchBar = -10,
	
	UIEventsAndPropertiesNativeItemPicker = -11,
	UIEventsAndPropertiesNativeItemDatePicker = -12,
	
	UIEventsAndPropertiesNativeItemInfoLight = -13,
	UIEventsAndPropertiesNativeItemInfoDark = -14,
	
	UIEventsAndPropertiesNativeItemDisclosure = -15,
	
	UIEventsAndPropertiesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all EventsAndProperties instances of
