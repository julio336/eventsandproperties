 ...
 * Copyright (c) 2009-2011 by EventsAndProperties, Inc. All Rights Reserved.
...
//@interface EventsAndPropertiesObject : NSObject
//@end

@interface EventsAndPropertiesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[EventsAndPropertiesObject class]])
		{
			for (NSString *key in [[(EventsAndPropertiesObject*)o modules] allKeys])
			{
